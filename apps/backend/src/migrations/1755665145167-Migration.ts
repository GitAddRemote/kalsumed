...
export class Migration1755665145167 implements MigrationInterface {
  name = 'Migration1755665145167'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX "IDX_1447359a831bec1e7bf74cdd38"
      ON "o_auth_account" ("provider", "provider_user_id")
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE "app_user" (
        ...
        CONSTRAINT "UQ_c480e576dd71729addbc2d51b67" UNIQUE ("username"),
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX "IDX_3fa909d0e37c531ebc23770339" ON "app_user" ("email")
    `);

    await queryRunner.query(`
      CREATE UNIQUE INDEX "IDX_c480e576dd71729addbc2d51b6" ON "app_user" ("username")
    `);
    ...
    /* ───── Add foreign keys (no PK/constraint churn) ───── */

    await queryRunner.query(`
      ALTER TABLE "o_auth_account"
      ADD CONSTRAINT "FK_29d00b3e31c438b1daca174d742"
    ...
    await queryRunner.query(`
      ...
      ADD CONSTRAINT "FK_d0e5815877f7395a198a4cb0a46"
      FOREIGN KEY ("user_id") REFERENCES "app_user"("id")
      ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    ...
    await queryRunner.query(`
      ALTER TABLE "user_role"
      ADD CONSTRAINT "FK_32a6fc2fcb019d8e3a8ace0f55f"
    ...
    await queryRunner.query(`
      ...
      ADD CONSTRAINT "FK_3d0a7155eafd75ddba5a7013368"
      FOREIGN KEY ("role_id") REFERENCES "role"("id")
    ...
    await queryRunner.query(`
      ALTER TABLE "role_permission"
      ADD CONSTRAINT "FK_e3a3ba47b7ca00fd23be4ebd6cf"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    /* Drop indexes created explicitly */
    ...
    /* Drop tables (indexes/constraints on them are dropped automatically) */
    await queryRunner.query(`DROP TABLE "role_permission"`);
    await queryRunner.query(`DROP TABLE "permission"`);
    await queryRunner.query(`DROP TABLE "role"`);
    await queryRunner.query(`DROP TABLE "app_user"`);  /* depends on enums */
