...
export class Migration1756083665626 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_c480e576dd71729addbc2d51b6"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP TYPE "public"."app_user_activity_level_enum"
        `);
        await queryRunner.query(`
            DROP TYPE "public"."app_user_gender_enum"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_1447359a831bec1e7bf74cdd38"
        `);
        await queryRunner.query(`
            DROP TABLE "o_auth_account"
        `);
        await queryRunner.query(`
